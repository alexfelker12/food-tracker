...
interface TextFieldProps extends React.ComponentProps<typeof Field> {
  label: string
  description: string
  placeholder: string
...
interface TextFieldInputProps extends Pick<TextFieldProps, "field" | "fieldState" | "placeholder"> { }
